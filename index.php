...
session_start();
$MySQL = mysqli_connect("localhost","root","","izrada_webstranica_php") or die('Neuspjelo povezivanje na MySQL server.');
...
include_once("datum_funkcija.php");
...
<body>
    <header>
        <div'; if ($menu > 1) {} else { print ' class="banner"'; }
        print '></div>
        <nav>';
            include("nav.php");
        print '</nav>
	...
	else if ($menu == 7) { include("administracija.php"); }
    else if ($menu == 10) { include("weather-api.php"); }
    else if ($menu == 11) { include("nasa-api.php"); }
	
	print '

    <footer>
        <p>Copyright &copy; 2024 Aldo Grabić<a href="https://github.com/aldograbic?tab=repositories"><img src="img/GitHub-Mark-Light-32px.png" alt="Github"></a></p>
    </footer>
