	...
	error_reporting(E_ALL);
		...
		if ($_POST['_action_'] == FALSE) {
			...
			<form id="forma" action="" method="POST">
				...
				<input type="text" name="ime" required autofocus>
			...
			if ($row['email'] == '' || $row['korisnicko_ime'] == '') {
				...
				$_SESSION['message'] = '<p>' . ucfirst(strtolower($_POST['ime'])) . ' ' .  ucfirst(strtolower($_POST['prezime'])) . ', hvala na registraciji! Sada se možete prijaviti u sustav!</p>';
