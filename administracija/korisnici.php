<?php
	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		<form action="" id="forma_uredi" name="forma" method="POST">
			...
			<br>
            <input type="radio" name="odobren" value="YES"'; if($row['odobren'] == 'YES') { echo ' checked="checked"'; $checked_archive = true; } echo ' /> DA &nbsp;&nbsp;
			<input type="radio" name="odobren" value="NO"'; if($checked_archive == false) { echo ' checked="checked"'; } echo ' /> NE
			<br>
				...
				<table>
					...
					while($row = @mysqli_fetch_array($result)) {
						...
						<tr>
							...
							<td>';
								if ($row['uloga'] == 1) { print '<img src="img/admin.png" alt="" title="" />'; }
								else if ($row['uloga'] == 3) { print '<img src="img/userman.png" alt="" title="" />'; }
								else if ($row['uloga'] == 2) { print '<img src="img/editor.png" alt="" title="" />'; }
							print '
							</td>
						</tr>';
					}
