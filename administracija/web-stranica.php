	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		<form action="" id="forma_uredi" name="forma" method="POST" enctype="multipart/form-data">
			...
			if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
            	...
            	<input type="radio" name="arhivirano" value="YES"> DA &nbsp;&nbsp;
				<input type="radio" name="arhivirano" value="NO" checked> NE';
			}
			print '
			<hr>
		...
		<form action="" id="forma_uredi" name="forma" method="POST" enctype="multipart/form-data">
			...
			<label for="arhivirano">Arhivirano:</label><br />
            <input type="radio" name="arhivirano" value="YES"'; if($row['arhivirano'] == 'YES') { echo ' checked="checked"'; $checked_archive = true; } echo ' /> DA &nbsp;&nbsp;
			<input type="radio" name="arhivirano" value="NO"'; if($checked_archive == false) { echo ' checked="checked"'; } echo ' /> NE
			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td>';
							if ($row['arhivirano'] == 'YES') { print '<img src="img/inactive.png" alt="" title="" />'; }
                            else if ($row['arhivirano'] == 'NO') { print '<img src="img/active.png" alt="" title="" />'; }
						print '
						</td>
					</tr>';
				}
